...
void calcMotorSpeed(){
  ...
  //모터 속도 보정(호버링)//
  motorA_speed = (throttle == 0) ? 0 : throttle + yaw_output + roll_output + pitch_output + 6;
  motorB_speed = (throttle == 0) ? 0 : throttle - yaw_output - roll_output + pitch_output + 5 ;
  motorC_speed = (throttle == 0) ? 0 : throttle + yaw_output - roll_output - pitch_output + 3;
